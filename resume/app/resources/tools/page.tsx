                    ...
                    <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card className="bg-background border-primary/20 hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] transition-all duration-300 h-full flex flex-col">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Developer-first security for Next.js. Protect your app from bots, attacks, and abuse.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="flex-1 flex flex-col">
                                <p className="mb-4 text-sm text-muted-foreground">
                                    Arcjet helps developers protect their apps with rate limiting, bot detection, and attack protection
